                ...
                $($image).draggable({
                    ...
                    drag: function (event, ui) {
                        ...
                        if ($options.image.onImageDrag != null)
                            $options.image.onImageDrag($image,getData('image'),_self.data('selector'));
                            ...
                            slide: function (event, ui) {
                                ...
                                if ($options.image.onZoom != null) {
                                    $options.image.onZoom($image,
                                        getData('image'),_self.data('selector'));
                                }
                            }
                        });
                            ...
                            drag: function (event, ui) {
                                ...
                                if ($options.selector.onSelectorDrag != null)
                                    $options.selector.onSelectorDrag(
                                        $selector,_self.data('image'),getData('selector'));
                            },
                            stop: function (event, ui) {
                                // hide overlay
                                ...
                                if ($options.selector.onSelectorDragStop != null)
                                    $options.selector
                                        .onSelectorDragStop(
                                            $selector,
                                            getData('selector'),_self.data('image'));
                            }
                        });
                    $selector
                        .resizable({
